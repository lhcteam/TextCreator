package com.woxiangnile.lhc.myapplication;
...
public class TextCreator {
     ...
     * @return
     */
    public TextCreator addTextOfColor(String text, String color) {
        mStringBuilder.append(text);
        texts.add(text.length());
        values.add((float) Color.parseColor(color));
